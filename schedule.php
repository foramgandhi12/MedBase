...
<html>
    <head>
        ...
        <!-- fullCalendar -->
        <link rel="stylesheet" href="node_modules/admin-lte/plugins/fullcalendar/main.css">
        <!-- Theme style -->
    ...
    <body class="hold-transition sidebar-mini">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card">
                            ...
                            <div id="external-events">
                                ...
                                <div class="external-event bg-warning">Post-Surgery Assessment</div>
                                <div class="external-event bg-info">Appointment</div>
                                <div class="external-event bg-danger">Surgery</div>
                                <div class="checkbox">
        ...
        <script src="node_modules/admin-lte/plugins/fullcalendar/main.js"></script>
