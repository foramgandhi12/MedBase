<!-- 
    Display the list of nurses to the user, create connection to the database, create tables
-->
...
<body>
    <div>
        <h1 style = "text-align: center;">List of Nurses</h1>
    </div>
    ...
    <?php
        ...
        if(mysqli_connect_errno()){
            ...
            while ($row = mysqli_fetch_row($result)){
                ...
                <td>".$row[3]."</td> <td>".$row[10]."</td> <td>".$row[5]."</td> <td>".$row[6]."</td> 
                <td>".$row[7]."</td> </tr>";
            }
            echo "</table>";
        }
